...
#define TRACK_MAIN_POWER_SIGNAL_PIN 18
#define TRACK_MAIN_POWER_CTRL_PIN 22
#define TRACK_MAIN_POWER_ADC_NUM 0

#define TRACK_PROG_POWER_SIGNAL_PIN 19
...
static PicoDccController pico_controller(
	(track_settings_t){TRACK_MAIN_POWER_SIGNAL_PIN, TRACK_MAIN_POWER_CTRL_PIN, TRACK_MAIN_POWER_ADC_NUM}, 
	(track_settings_t){TRACK_PROG_POWER_SIGNAL_PIN, TRACK_PROG_POWER_CTRL_PIN, TRACK_PROG_POWER_ADC_NUM}
	);
